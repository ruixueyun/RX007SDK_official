...
Pod::Spec.new do |s|
  s.name             = 'RX007SDK_official'
  s.version          = '1.0.0'
  s.summary          = 'ruixue RX007SDK_official framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RX007SDK_official'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RX007SDK_official.git', :tag => s.version.to_s }
